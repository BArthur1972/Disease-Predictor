...
ORIGINAL_PROGNOSIS = np.array([
    ...
    'Heart attack', 'Hepatitis B', 'Hepatitis C', 'Hepatitis D', 'Hepatitis E',
...
DATA_DICT = {
    ...
    "predictions_classes": ORIGINAL_PROGNOSIS
}
